...
const OrganizationSection = (props) => {
    ...
    return (
        <div className="org-section">
            ...
            {org.address.address1 !== null? <ul>{org.address.address1}</ul> : null}
            {org.address.address2 !== null? <ul>{org.address.address2}</ul> : null}
            {org.address.city !== null && org.address.state !== null && org.address.postcode !== null? <ul>{org.address.city + ", " + org.address.state + " " + org.address.postcode}</ul> : null}
